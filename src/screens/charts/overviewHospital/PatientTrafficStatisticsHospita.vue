...
const data = computed(() => overviewHospital.data.patientTrafficStatistics || []);
    ...
    <card-module title="患者流量统计">
      <div class="item" v-for="(item, index) in data" :key="index">
        <div class="header">
          ...
          <p class="value">
            <span v-num-rolling="item.value"></span>
            <span class="unit">{{ item.unit }}</span>
          </p>
          <p class="percentage">
            <rate-number type="increase" :value="item.percentage" />
          </p>
        </div>
